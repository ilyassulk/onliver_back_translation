package ru.onliver.translation_gc.enums;
...
/**
 * Перечисление типов событий трансляции для обмена через Kafka.
 * Включает события начала, запланированного и экстренного завершения трансляций.
 */
